  ...
  return (
    <div className="min-h-screen bg-asanoha grid place-items-center p-6 text-center">
      <div className="animate-fade-up">
        ...
        <div className="hanko h-24 w-24 text-5xl mx-auto animate-float">🧭</div>
        <h1 className="font-display text-5xl font-bold text-sumi mt-6">404</h1>
        <p className="font-round text-shu mt-1">Halaman Tidak Ditemukan</p>
