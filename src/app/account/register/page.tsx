    ...
    <div className="min-h-screen bg-asanoha grid place-items-center p-5 relative overflow-hidden">
      ...
      <div className="w-full max-w-sm animate-fade-up">
        ...
        <div className="paper-card rounded-[1.75rem] p-8">
          ...
          <p className="text-sm text-sumi/50 mt-1">Checkout lebih cepat & lihat riwayat order.</p>
          ...
          <form onSubmit={submit} className="mt-6 space-y-3.5">
            ...
            <div>
              ...
              <input type="password" value={password} onChange={(e) => setPassword(e.target.value)} placeholder="Minimal 6 karakter" className="mt-1 w-full rounded-xl border border-sumi/15 bg-washi/40 px-4 py-2.5 text-sm outline-none focus:border-shu focus:ring-2 focus:ring-shu/20" required />
            </div>
